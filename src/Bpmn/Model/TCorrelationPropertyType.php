...
class TCorrelationPropertyType extends TRootElementType
{
    ...
    /**
     * @property \Bpmn\Model\CorrelationPropertyRetrievalExpression[]
     ...
     *
     * @return self
     * @param \Bpmn\Model\CorrelationPropertyRetrievalExpression
     * $correlationPropertyRetrievalExpression
     */
    public function addToCorrelationPropertyRetrievalExpression(\Bpmn\Model\CorrelationPropertyRetrievalExpression $correlationPropertyRetrievalExpression)
    {
     ...
     *
     * @return \Bpmn\Model\CorrelationPropertyRetrievalExpression[]
     */
