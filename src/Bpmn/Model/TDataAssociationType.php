...
class TDataAssociationType extends TBaseElementType
{
    ...
    /**
     * @property \Bpmn\Model\TFormalExpressionType $transformation
     */
    private $transformation = null;

    /**
     * @property \Bpmn\Model\Assignment[] $assignment
     */
     ...
     *
     * @param \Bpmn\Model\TFormalExpressionType $transformation
     * @return self
     */
    public function setTransformation(\Bpmn\Model\TFormalExpressionType $transformation)
    {
     ...
     *
     * @return self
     * @param \Bpmn\Model\Assignment $assignment
     */
    public function addToAssignment(\Bpmn\Model\Assignment $assignment)
    {
