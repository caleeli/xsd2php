...
class TInterfaceType extends TRootElementType
{
    ...
    /**
     * @property \Bpmn\Model\Operation[] $operation
     */
     ...
     *
     * @return self
     * @param \Bpmn\Model\Operation $operation
     */
    public function addToOperation(\Bpmn\Model\Operation $operation)
    {
