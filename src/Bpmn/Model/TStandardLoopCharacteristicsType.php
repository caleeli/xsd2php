...
class TStandardLoopCharacteristicsType extends TLoopCharacteristicsType
{
    ...
    /**
     * @property \Bpmn\Model\TExpressionType $loopCondition
     */
     ...
     *
     * @param \Bpmn\Model\TExpressionType $loopCondition
     * @return self
     */
    public function setLoopCondition(\Bpmn\Model\TExpressionType $loopCondition)
    {
