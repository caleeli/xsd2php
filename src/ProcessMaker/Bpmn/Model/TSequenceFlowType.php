...
class TSequenceFlowType extends TFlowElementType
{
    ...
    /**
     * @property \ProcessMaker\Bpmn\Model\TExpressionType $conditionExpression
     */
     ...
     *
     * @param \ProcessMaker\Bpmn\Model\TExpressionType $conditionExpression
     * @return self
     */
    public function setConditionExpression(\ProcessMaker\Bpmn\Model\TExpressionType $conditionExpression)
    {
