...
class TResourceType extends TRootElementType
{
    ...
    /**
     * @property \ProcessMaker\Bpmn\Model\ResourceParameter[] $resourceParameter
     */
     ...
     *
     * @return self
     * @param \ProcessMaker\Bpmn\Model\ResourceParameter $resourceParameter
     */
    public function addToResourceParameter(\ProcessMaker\Bpmn\Model\ResourceParameter $resourceParameter)
    {
     ...
     *
     * @return \ProcessMaker\Bpmn\Model\ResourceParameter[]
     */
