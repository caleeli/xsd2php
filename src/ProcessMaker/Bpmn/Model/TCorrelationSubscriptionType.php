...
class TCorrelationSubscriptionType extends TBaseElementType
{
    ...
    /**
     * @property \ProcessMaker\Bpmn\Model\CorrelationPropertyBinding[]
     ...
     *
     * @return self
     * @param \ProcessMaker\Bpmn\Model\CorrelationPropertyBinding
     * $correlationPropertyBinding
     */
    public function addToCorrelationPropertyBinding(\ProcessMaker\Bpmn\Model\CorrelationPropertyBinding $correlationPropertyBinding)
    {
     ...
     *
     * @return \ProcessMaker\Bpmn\Model\CorrelationPropertyBinding[]
     */
